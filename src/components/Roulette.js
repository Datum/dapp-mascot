...
ctx = canvas.getContext('2d');
 ...
 image.onload = function() {
        ctx.drawImage(image,80,80,canvas.width-150,canvas.height-150);
}
...
const angle = startAngle ;
  ...
  render() {
    ...
    return (
      ...
      <div className="canvasRoulette">
        <div className="canvasRoulette-container">
          <canvas ref="canvas" width={baseSize * 2} height={baseSize * 2} className="roulette-canvas"></canvas>

          <a id="rouletteButton" onClick={this.handleOnClick}>{Language.rouletteSpin}</a>
