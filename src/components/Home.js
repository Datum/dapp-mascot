...
class Home extends Component {
  ...
  next=()=>{
    (this.props.mascotCreated)?this.props.handleStep(6):this.props.handleStep("up");
 }
  render() {

   console.log('fd',this.props.finalDone,'mc',!this.props.finalDone&&this.mascotCreated);
